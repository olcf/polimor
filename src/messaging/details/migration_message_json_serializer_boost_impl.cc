...
template<>
std::string_view 
json_serializer_impl<migration_message>::operator()(
        const migration_message &msg, 
...
template<>
std::string 
json_serializer_impl<migration_message>::operator()(const migration_message& msg) const {
