...
template<>
std::string_view 
json_serializer_impl<recorder_message>::operator()(
        const recorder_message &msg, 
...
template<>
std::string
json_serializer_impl<recorder_message>::operator()(const recorder_message &msg) const {
